      ...
      <div className='navbar-fixed'>
        <nav>
          ...
          <ul className="right hide-on-small-only"> {/* on regular screens */}
            ...
            <li><a href="#" onClick={this.props.toggleSidebarRight}><i className="material-icons left">video_library</i>Playlists</a></li>
          </ul>
          <ul className="right hide-on-med-and-up"> {/* on mobile screens */}
            <li><a href="#"><i className="material-icons">person_pin</i></a></li>      
            <li><a href="#" onClick={this.props.toggleSidebarRight}><i className="material-icons">video_library</i></a></li>      
          </ul>
        </nav>
      </div>
    );
